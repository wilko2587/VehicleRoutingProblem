...
import environment_DepotNoWindow as environment
import pandas as pd
...
class DQNAgent:
    def __init__(self):
        ...
        self.eps_decay_start = 500 # how many episodes before beginning epsilon decay
        ...
        for e in range(self.EPISODES):
            ...
            while not done and i < max_iterations:
                ...
                if done:
                    ...
                    time_taken, serviced, remaining = self.env.get_stats()
                    print("episode: {}/{}, stops_made: {}, epsilon: {:.2}, r: {}, t: {}, serviced: {}, remaining: {}".format(e+1, self.EPISODES, i, self.epsilon, total_reward, time_taken, serviced, remaining))
...
if __name__ == "__main__":
    ...
    plt.xlabel('Episodes')
    plt.ylabel('Score')
    plt.savefig("Depot1.png")

    plt.plot(episodes, stops)
    plt.xlabel('Episodes')
    plt.ylabel('Stops')

    plt.savefig('Depot2.png')
    plt.show()